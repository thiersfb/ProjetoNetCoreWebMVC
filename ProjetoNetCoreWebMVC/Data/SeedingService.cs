...
using ProjetoNetCoreWebMVC.Models.Enums;
using System;
...
namespace ProjetoNetCoreWebMVC.Data
{
    public class SeedingService
    {
        ...
        private ProjetoNetCoreWebMVCContext _context;

        //injeção de dependência. Quando um SeedingService for criado, ele irá receber automaticamente uma instância do context tbm
        public SeedingService(ProjetoNetCoreWebMVCContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s3 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500, d2);
            Seller s2 = new Seller(3, "Alex Grey", "alexg@gmail.com", new DateTime(1988, 1, 15), 2200, d1);
